...
const packageTypes = [
  ...
  },
  {
    ...
    title: 'Land Package',
    description: 'Complete travel packages including accommodation, activities, and transportation',
    icon: PackageIcon,
    features: ['Accommodation', 'Activities', 'Transportation', 'Meals'],
    color: 'purple',
    popular: true,
    exampleUseCase: 'Comprehensive packages for multi-day trips with everything included',
    duration: '3-14 days',
  ...
  },
  {
    ...
    description: 'Accommodation packages with additional services and activities',
    icon: Building,
    features: ['Hotel Stay', 'Room Service', 'Amenities', 'Local Activities'],
    color: 'orange',
    popular: true,
    exampleUseCase: 'Hotel-focused packages with added experiences and services',
    duration: '2-7 days',
  ...
  },
  {
    ...
    description: 'Flight packages with fixed departure dates and additional services',
    icon: Plane,
    features: ['Flights', 'Seat Selection', 'Baggage', 'Ground Services'],
    color: 'sky',
    popular: false,
    exampleUseCase: 'Fixed departure tours with flights included and scheduled itineraries',
    duration: '5-21 days',
